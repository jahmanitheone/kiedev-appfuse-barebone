...
synproperty : (ALPHA|ALPHALOWERCASE|ALPHAUPPERCASE)+;
...
//assignStringSynIdPropertyValue : synidproperty (CONSTANT_EQUAL|CONSTANT_NOTEQUAL) 
//                                 CONSTANT_QUOTE (ALPHAUPPERCASE|ALPHA|ALPHALOWERCASE|DIGIT (UNDERSCORE)) CONSTANT_QUOTE;  
...
DIGIT : [0-9] ;
DIGITS : DIGIT (DIGIT)* ;
FLOAT: DIGITS CONSTANT_PERIOD DIGITS;
PERCENT: DIGITS '%' |
