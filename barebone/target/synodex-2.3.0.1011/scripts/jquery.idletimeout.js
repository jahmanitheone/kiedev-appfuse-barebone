 ...
 *   * * 
 *   Depends: *  - jQuery 1.4.2+ *  - jQuery Idle Timer (by Paul Irish, http://paulirish.com/2009/jquery-idletimer-plugin/)
...
$.idleTimeout = function(element, resume, options){
	...
	$.idleTimeout.options = {	
			...
			/*			Callbacks			"this" refers to the element found by the first selector passed to $.idleTimeout.		*/
