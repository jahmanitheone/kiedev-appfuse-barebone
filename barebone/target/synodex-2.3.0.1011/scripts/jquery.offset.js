/* 
File: jquery.offset.js
The .offset() method allows us to retrieve the current position of an element relative to the document.  This plugin is used when setting the position of the Step 2 LHS Data Point Entry dialog.
