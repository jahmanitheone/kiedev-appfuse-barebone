/* 
File: jquery.ui.1.8.13.min.js
jQuery UI provides abstractions for low-level interaction and animation, advanced effects and high-level, themeable widgets, built on top of the jQuery JavaScript Library, that you can use to build highly interactive web applications.  This is an original jQuery library and is used throughout the site.

Notes: 
- JQuery UI 1.8.16  is now available.  This library needs updated and regression testing must be performed.
